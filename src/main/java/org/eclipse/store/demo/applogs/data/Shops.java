...
public class Shops extends ReadWriteLocked
{
	...
	/**
	 * Adds a new shop and stores it with the {@link AppLogsDemo}'s {@link EmbeddedStorageManager}.
	 * <p>
	 * This is a synonym for:<pre>this.add(shop, AppLogsDemo.getInstance().storageManager())</pre>
	 *
	 * @param shop the new shop
	 */
	public void add(final Shop shop)
	{
		this.add(shop, AppLogsDemo.getInstance().storageManager());
	}
	...
	/**
	 * Adds a range of new shops and stores it with the {@link AppLogsDemo}'s {@link EmbeddedStorageManager}.
	 * <p>
	 * This is a synonym for:<pre>this.addAll(shops, AppLogsDemo.getInstance().storageManager())</pre>
	 *
	 * @param shops the new shops
	 */
	public void addAll(final Collection<? extends Shop> shops)
	{
		this.addAll(shops, AppLogsDemo.getInstance().storageManager());
	}
