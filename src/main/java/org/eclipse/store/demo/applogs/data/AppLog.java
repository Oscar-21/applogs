...
import static org.eclipse.store.demo.applogs.util.ValidationUtils.requireNonBlank;
import static org.eclipse.store.demo.applogs.util.ValidationUtils.requireNonEmpty;
 ...
 *
 */
public class AppLog extends Named
{
	...
	/**
	 * Constructor to create a new {@link AppLog} instance.
	 *
	 ...
	 * @throws IllegalArgumentException if the given level is empty or <code>null</code>
	 */
	public static Level validateLevel(final Level level)
	{
		return requireNonNull(level, () -> "Level cannot be null");
	}
	
	/**
	 * Validates the given timestamp.
	 * It is returned if not empty or <code>null</code>, otherwise an exception is thrown.
	 *
	 * @param timestamp the timestamp to validate
	 * @return the given timestamp
	 * @throws IllegalArgumentException if the given timestamp is empty or <code>null</code>
	 */
	public static LocalDateTime validateTimestamp(final LocalDateTime timestamp)
	{
