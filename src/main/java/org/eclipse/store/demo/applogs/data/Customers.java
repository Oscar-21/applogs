...
public class Customers extends ReadWriteLocked
{
	...
	/**
	 * Adds a new customer and stores it with the {@link AppLogsDemo}'s {@link EmbeddedStorageManager}.
	 * <p>
	 * This is a synonym for:<pre>this.add(customer, AppLogsDemo.getInstance().storageManager())</pre>
	 *
	 * @param customer the new customer
	 */
	public void add(final Customer customer)
	{
		this.add(customer, AppLogsDemo.getInstance().storageManager());
	}
	...
	/**
	 * Adds a range of new customers and stores it with the {@link AppLogsDemo}'s {@link EmbeddedStorageManager}.
	 * <p>
	 * This is a synonym for:<pre>this.addAll(customers, AppLogsDemo.getInstance().storageManager())</pre>
	 *
	 * @param customers the new customers
	 */
	public void addAll(final Collection<? extends Customer> customers)
	{
		this.addAll(customers, AppLogsDemo.getInstance().storageManager());
	}
