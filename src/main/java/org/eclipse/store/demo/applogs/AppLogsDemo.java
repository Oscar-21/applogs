...
import org.eclipse.store.demo.applogs.data.Data;
import org.eclipse.store.demo.applogs.data.DataMetrics;
 ...
 */
public final class AppLogsDemo implements HasLogger
{
	private static AppLogsDemo instance;

	/**
	 * @return the single instance of this class
	 */
	public static AppLogsDemo getInstance()
	{
		return instance;
	}
	 ...
	 */
	public AppLogsDemo(final RandomDataAmount initialDataAmount)
	{
		super();
		this.initialDataAmount = initialDataAmount;
		AppLogsDemo.instance = this;
	}
