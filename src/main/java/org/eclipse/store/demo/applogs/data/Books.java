...
import org.eclipse.store.demo.applogs.data.Index.DocumentPopulator;
import org.eclipse.store.demo.applogs.data.Index.EntityMatcher;
...
public class Books extends ReadWriteLocked
{
	...
	/**
	 * Adds a new book and stores it with the {@link AppLogsDemo}'s {@link EmbeddedStorageManager}.
	 * <p>
	 * This is a synonym for:<pre>this.add(book, AppLogsDemo.getInstance().storageManager())</pre>
	 *
	 * @param book the new book
	 */
	public void add(final Book book)
	{
		this.add(book, AppLogsDemo.getInstance().storageManager());
	}
	...
	/**
	 * Adds a range of new books and stores it with the {@link AppLogsDemo}'s {@link EmbeddedStorageManager}.
	 * <p>
	 * This is a synonym for:<pre>this.addAll(books, AppLogsDemo.getInstance().storageManager())</pre>
	 *
	 * @param books the new books
	 */
	public void addAll(final Collection<? extends Book> books)
	{
		this.addAll(books, AppLogsDemo.getInstance().storageManager());
	}
