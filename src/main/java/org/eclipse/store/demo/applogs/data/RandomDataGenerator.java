...
/**
 * Random data generator for the {@link AppLogsDemo}'s {@link Data} root.
 * <p>
...
public class RandomDataGenerator implements HasLogger
{
	...
	)
	{
		...
		final MonetaryAmount purchasePrice = AppLogsDemo.money(this.randomPurchasePrice());
		final MonetaryAmount retailPrice   = AppLogsDemo.retailPrice(purchasePrice);
